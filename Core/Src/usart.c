...
void MX_UART4_Init(void)
{
  ...
  HAL_UARTEx_ReceiveToIdle_DMA(&huart4, uart4_dma_buffer, sizeof(uart4_dma_buffer));
...
void MX_USART2_UART_Init(void)
{
  ...
  HAL_UARTEx_ReceiveToIdle_DMA(&huart2, uart2_dma_buffer, sizeof(uart2_dma_buffer));
...
void MX_USART6_UART_Init(void)
{
  ...
  HAL_UARTEx_ReceiveToIdle_DMA(&huart6, uart6_dma_buffer, sizeof(uart6_dma_buffer));
